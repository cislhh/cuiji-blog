  ...
  projects: [
    {
      ...
      longDescription:
        '这是我开发的个人博客系统，使用 Next.js 15 和 App Router 架构重构完成，原博客系统因为技术栈老旧不好迁移直接废弃。系统支持 MDX 格式的文章写作、代码语法高亮、数学公式渲染、标签分类等功能。博客采用响应式设计，完美适配各种设备，支持深色模式，集成了现代化的 UI 组件和流畅的动画效果，提供优质的阅读体验。',
      type: 'website',
    ...
    },
    {
      ...
      longDescription:
        '这是基于 Bootstrap 开发的企业官方网站，采用响应式设计，支持多终端访问。网站包含产品展示、解决方案、新闻中心、关于我们等模块，集成了在线客服系统，为用户提供便捷的咨询服务。',
      type: 'website',
      ownershipType: 'company',
      date: '2022.05',
      images: [
