...
keywords: ['canada', 'travel', 'photo gallery', 'images', 'next js']
draft: false
layout: PostBanner
...
description: '加拿大风光摄影展，展现枫叶、雪山、碧蓝湖泊和多伦多的美景。本文演示如何使用 MDX 和 Tailwind CSS 创建响应式图片画廊，并利用 Next.js Image 组件优化图片加载。'
---
